...
{ 
	...
	$category_id = get_cat_ID($categoryName); // Получает ID категории по переданному названию.
	$termchildren = get_term_children( $category_id, 'category' ); //Объединяет в массив и возвращает все дочерние разделы элемента таксономии (категории).
	 //*********************************************
